                  ...
                  <br><small>Contact : <?php echo $contact; ?></small>
                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="http://localhost/entc_wbms/admin/?page=clientbillings&phone_number=<?php echo urlencode($phone_number); ?>" class="nav-link nav-clients active bg-gradient-primary">
                    ...
                    <li class="nav-item dropdown">
                      <a href="http://localhost/entc_wbms/admin/?page=monthlybill&phone_number=<?php echo urlencode($phone_number); ?>" class="nav-link nav-billings ">
